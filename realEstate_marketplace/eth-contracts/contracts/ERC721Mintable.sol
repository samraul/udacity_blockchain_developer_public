...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != address(0), "Can't approve invalid address");

        address tokenOwner = ownerOf(tokenId);
        // DONE require the given address to not be the owner of the tokenId
        require(tokenOwner != to, "Can't approve owner of the token.");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        return _tokenApprovals[tokenId]; // returns address(0) if it doesn't exist
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Can't mint to invalid address.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Only the owner can transfer the token.");

        // DONE: require token is being transfered to valid address
        require(address(0) != to, "Can't transfer to invalid address.");
...
contract RSRealStateToken is ERC721Metadata("RS Real State Token", "RSRS", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
    ...
    function mintWithURI(address to, uint256 tokenId, string memory tokenURI) public onlyOwner returns(bool) {
